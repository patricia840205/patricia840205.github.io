...
if (!empty($_GET['housemsgedit'])){
  //查詢 edit 參數所指定編號的記錄, 從資料庫將原有的資料取出
  $sql="SELECT * FROM housemsg WHERE 留言編號 = '{$_GET['housemsgedit']}' ";
...
<div id="maintext" style="text-align: left; padding-left:100px;"> 
  ...
  <form method="post" action="housemsgeditsuccess.php" style="padding-left:250px;">
    姓名: <?php echo $row['姓名'];?>
  ...
  <p><a href="housedetailed.php?housetailed=<?php echo $_GET['housemsgedit']; ?>" style="float:right;">返回</a></p>
</div>
