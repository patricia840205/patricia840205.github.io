...
if (!empty($_POST['myname']) && !empty($_POST['message'])){
	$sql="INSERT INTO message (姓名, 留言, topicid)
...
<h2>留言:</h2>
  ...
  <form id="addpost" method="post" action="messagesuccess.php" name="addmsg">
	...
	<?php
	echo "<input type='hidden' name='topicid' value={$_GET['saledetailed']} ></input>";
	?>
